...
from detection_engineering.chronicle.detection_engine.v2.create_rule_version import create_rule_version
...
class CreateRuleVersionTest(unittest.TestCase):
  ...
  def test_happy_path(
    ...
    self.assertEqual(new_rule_version["versionId"], expected_version_id)
