...
from detection_engineering.chronicle.detection_engine.v2.create_rule import create_rule
...
class CreateRuleTest(unittest.TestCase):
  ...
  def test_http_error(
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      create_rule(http_session=mock_session, rule_content="new rule content")
  ...
  def test_happy_path(
    ...
    actual_rule = create_rule(
        http_session=mock_session, rule_content="new rule content"
    )
